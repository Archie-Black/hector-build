        ...
        {tab === "System" ? (
          <>
            ...
            <p className="mt-2 text-sm text-pretty">
              ...
              Arcade and Google Cloud are federations only. ContextForge is on, full time. Shared workspaces: any build bot joins at /api/v1/share. SSH and backend terminals are how they work together. Credentials stay in the backend. Onion is for bot-to-bot SSH off-LAN only. PuTTY on Windows.
            </p>
