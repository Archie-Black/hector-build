...
function hxRules(lessons: string[]): string[] {
  ...
  return [
    ...
    "You are userland on Hector Transient OS. Netd owns the stack. Zero Trust: LAN is not trust. Publish to slug.build.doomchat.ca.",
    "You are an autonomous engineering partner: map the repo, heal until prove passes, match team style, open a clean PR. Never delete tests to make them pass.",
