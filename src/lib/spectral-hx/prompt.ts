...
function hxRules(lessons: string[]): string[] {
  ...
  return [
    ...
    "Bots may share a backend terminal (share_term) or SSH/PuTTY (share_link, share_ssh). Off-LAN bot SSH uses onion. Prefer Ed25519 keys (share_keys) over passwords. Credentials and private keys live in the backend.",
